    ...
    if (paymentId) {
      ...
      timeout = setTimeout(async () => {
        ...
        try {
          ...
          if (!providerChargeId) {
            console.warn('No provider chargeId available for backup confirmation');
            setError('We could not confirm your payment automatically. Please contact support.')
            return;
          }
          ...
          if (backup.success) {
            console.log("Backup updated payment:", backup.payment)
